...
const routes: Routes = [
  ...
  { path: 'tabs-profesor', component: TabsProfesorComponent, canActivate: [ AuthcentroGuard ],
    children: [
      ...
      { path: 'clases/:nombreClase', component: MisClasesProfesorPage, canActivate: [ AuthcentroGuard ]},
      ...
      { path: 'clases/proximos-examenes/:idClase/:asignatura', component: MisExamenesProfesorPage, canActivate: [ AuthcentroGuard ]},
      { path: 'clases/proximos-examenes/:idClase/:asignatura/:nombreExamen', component: MisExamenesProfesorPage, canActivate: [ AuthcentroGuard ]},
      { path: 'clases/examenes-realizados/:idClase/:asignatura', component: ExamenesRealizadosPage, canActivate: [ AuthcentroGuard ]},
      { path: 'clases/examenes/:idClase/:idExamen/:asignatura/notas', component: MisExamenesNotasProfesorPage, canActivate: [ AuthcentroGuard ]},
  ...
  { path: 'tabs-alumno', component: TabsAlumnoComponent, canActivate: [ AuthcentroGuard ],
    children: [
      ...
      { path: 'asignaturas/info-asignatura/:idProfesor/:asignatura/:nombreExamen/examenes', component: MisExamenesAlumnoPage, canActivate: [ AuthcentroGuard ]},
      ...
      { path: 'asignaturas/info-asignatura/examenes/:idProfesor/notas/:nombreExamen', component: MisNotasAlumnoPage, canActivate: [ AuthcentroGuard ]},
